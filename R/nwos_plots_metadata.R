...
nwos_plots_metadata <- function(x){
  ...
  md <- data.frame(COLUMN=names(pc),
                   ...
                   UNITS_FACTORS=c(NA,'decimal degrees','decimal degrees',
                                   ...
                                   '41=Corporate, 44=Native American (Indian), 42=Non-governmental conservation/natural resources organization, 45=Individual, family, 43=Unincorporated local partnership/association/club',
                                   NA,
                                   '0=non-industrial or small corporate, 1=large corporate',
                                   '41=Corporate, 44=Native American (Indian), 42=Non-governmental conservation/natural resources organization, 45=Individual, family, 43=Unincorporated local partnership/association/club, CORP_LARGE=Large corporate, NPNF=Non-private and/or non-forest',
                                   NA,NA,
