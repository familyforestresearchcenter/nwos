...
get_nwos_w_incomplete <- function(cycle='2018',study='base',states=NA,questions=NA){
  ...
  AND r.RESPONSE_CD IN ('1','-2')
  AND (r.NONRESPONSE_REASON IS NULL OR r.NONRESPONSE_REASON IN ('3', '13'))
  ORDER BY r.CN,
