...
nwos_proportion_replicates <- function(r, index.rep, data,
                                       weight.rep,
                                       ...
                                       variable.name = "FFO")
{
  data <- data.frame(weight = weight.rep[[r]],
                     ...
                     base = unlist(data[index.rep[[r]], base.name]),
  ...
  nwos_total(weight = data$weight, area = data$area, domain = data$domain, variable = data$variable) /
    nwos_total(weight = data$weight, area = data$area, domain = data$base, variable = data$variable)
}
